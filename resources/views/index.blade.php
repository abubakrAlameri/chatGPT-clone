    ...
    <body class="antialiased min-h-screen md:px-2  ">
        ...
        <nav class="navbar fixed top-0 h-10 z-50 -bottom-2 shadow-lg bg-base-100 rounded-3xl  px-4">
            <div class="flex-1">
        ...
        <main class="flex items-stretch h-full md:mx-2 mb -5">
            <aside class="md:w-1/4 w-0 bg-base-300 rounded-l-3xl shadow-lg pt-10">
                <div class="shadow-lg px-5 pt-16 ">
            ...
            <section class="md:w-3/4 relative w-full rounded-r-xl  bg-neutral-focus ">
                <div  class="pt-16 pb-20 h-screen ">
                <div id="chat-container" class="h-full overflow-y-auto md:px-5 px-2">
                    <div class=" chat chat-end mb-3">
                        ...
                        <div class="chat-bubble relative">
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. A laboriosam placeat id
                            reprehenderit dolorum veniam optio eum magni hic voluptatum saepe accusantium, nostrum in
                            accusamus, inventore repellat eaque minima perferendis.
                            <div role="status"
                    ...
                    <div class="chat chat-start mb-3">
                        ...
                        <div class="chat-bubble">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sed libero
                            error blanditiis vel, nemo animi! Ea, sit. Blanditiis, odio! Perferendis quaerat minus atque
                            deleniti, exercitationem magni odit quasi hic placeat.</div>
                ...
                <div
                    class="w-full absolute bottom-0 grid grid-cols-12 gap-2 rounded-r-xl rounded-tl-xl bg-base-100  p-2 rounded-bl-none  bottom-0-0 left-0 right-0">
